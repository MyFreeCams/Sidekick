function(MFCDefines TheTarget)
	...
	set(MFC_DEFINES
		...
		MFC_AGENT_SVC_URL="${MFC_AGENT_SVC_URL}"
		MFC_API_SVR="${MFC_API_SVR}"
		MFC_BROWSER_AVAILABLE=${MFC_BROWSER_AVAILABLE}
		MFC_BROWSER_LOGIN=${MFC_BROWSER_LOGIN}
		MFC_DEFAULT_BROADCAST_URL="${MFC_DEFAULT_BROADCAST_URL}"
		MFC_FILE_SVR="${MFC_FILE_SVR}"
		MFC_LOG_LEVEL=${MFC_LOG_LEVEL}
		MFC_LOG_OUTPUT_MASK=${MFC_LOG_OUTPUT_MASK}
		MFC_MAX_DEADCOUNT=${MFC_MAX_DEADCOUNT}
		MFC_MAX_SLEEP_INTERVAL=${MFC_MAX_SLEEP_INTERVAL}
		...
		MFC_SERVICES_JSON_NAME_RTMP_VALUE="${MFC_SERVICES_JSON_NAME_RTMP_VALUE}"
		MFC_SERVICES_JSON_NAME_WEBRTC_VALUE="${MFC_SERVICES_JSON_NAME_WEBRTC_VALUE}"
		MFC_SERVICES_JSON_PRIMARY_SERVER_NAME="${MFC_SERVICES_JSON_PRIMARY_SERVER_NAME}"
		MFC_SERVICES_JSON_X264OPTS_VALUE="${MFC_SERVICES_JSON_X264OPTS_VALUE}"
		MFC_SERVICES_JSON_AUDIO_BITRATE_VALUE=${MFC_SERVICES_JSON_AUDIO_BITRATE_VALUE}
		MFC_SERVICES_JSON_VIDEO_BITRATE_VALUE=${MFC_SERVICES_JSON_VIDEO_BITRATE_VALUE}
	)
	set(MFC_DEFINES_CEF
