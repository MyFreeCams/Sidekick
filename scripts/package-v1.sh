...
main() {
  ...
  (cd "${BUILD_ROOT}" && "${OBSAGENTS_ROOT}/scripts/install/osx/packageApp-v1.sh")
  ...
  cp "${OBSAGENTS_ROOT}/scripts/install/osx/OBSPublicDSAKey.pem" "${BUILD_ROOT}/OBS-v1.app/Contents/Resources/"
  ...
  packagesbuild "${OBSAGENTS_ROOT}/scripts/install/osx/sidekick-v1.pkgproj"
