...
#define OBS_BROWSER_VERSION_MAJOR 24
#define OBS_BROWSER_VERSION_MINOR 0
...
#define OBS_BROWSER_VERSION_INT                          \
	MAKE_SEMANTIC_VERSION(OBS_BROWSER_VERSION_MAJOR, \
			      OBS_BROWSER_VERSION_MINOR, \
...
#define OBS_BROWSER_VERSION_STRING                                                      \
	...
	"." OBS_BROWSER_MACRO_STR(OBS_BROWSER_VERSION_MINOR) "." OBS_BROWSER_MACRO_STR( \
		OBS_BROWSER_VERSION_PATCH)
